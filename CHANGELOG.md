...
### Fixed
* Bug fixes (in `plom-common` package) involved accessing older servers.
...
[Unreleased]: https://gitlab.com/plom/plom-client/-/compare/v0.21.1...main
[0.21.1]: https://gitlab.com/plom/plom-client/-/compare/v0.21.0...v0.21.1
